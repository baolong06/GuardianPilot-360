"""
Training script for vehicle behavior classification using PIE dataset
"""
import sys
import os
...
# ========== TRAINING ==========
def train():
    config = get_config_for_task('pie_vehicle_behavior')
    paths = get_paths()
    ...
    logger = Logger(paths['log_root'], 'pie_vehicle_behavior')
    save_dir = os.path.join(paths['model_root'], 'pie_vehicle_behavior', 'weights')
